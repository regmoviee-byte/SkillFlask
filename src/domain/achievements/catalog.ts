...
export const LADDERS: readonly LadderDef[] = [
  ...
  {
    // Levels of every skill together, whatever each skill's progress theme: «уровни».
    id: 'flasks',
    title: 'Уровни',
    unit: ['уровень', 'уровня', 'уровней'],
    icon: 'flask-stack',
    description: 'Пройденные уровни всех навыков вместе.',
    howTo: 'Проходите уровни в любых навыках — считаются все, включая достигнутые и архивные навыки.',
    tiers: tiers([5, B], [10, S], [25, S], [50, G], [100, G]),
    value: (s) => s.global.totalCompletedFlasks,
    tierDescription: (n) => count(n, ['пройденный уровень', 'пройденных уровня', 'пройденных уровней']),
  },
  {
    id: 'milestones',
    title: 'Вехи',
    unit: ['веха', 'вехи', 'вех'],
    icon: 'flag',
    description: 'Навыки, в которых пройдено не меньше уровней, чем задано вехой.',
    howTo: 'Пройдите в навыке столько уровней, сколько задано его вехой.',
...
export const BADGES: readonly AchievementDef[] = [
  ...
  badge({
    ...
    description: 'Пройден первый уровень',
    howTo: 'Наберите очки на целый уровень в любом навыке.',
    rarity: B,
    icon: 'drop',
  ...
  badge({
    ...
    description: 'Три навыка, в каждом пройден хотя бы один уровень',
    howTo: 'Пройдите хотя бы по одному уровню в трёх разных навыках.',
    rarity: S,
    icon: 'compass',
    target: 3,
  ...
  badge({
    id: 'double',
    title: 'Двойное дно',
    description: 'Одно выполнение принесло два уровня',
    howTo: 'Отметьте выполнение, очков которого хватит сразу на два уровня.',
    rarity: S,
    icon: 'layers',
    target: 2,
  ...
  badge({
    id: 'exact',
    title: 'Ювелирно',
    description: 'Уровень пройден ровно, без остатка',
    howTo: 'Пройдите уровень так, чтобы на следующий не перешло ни одного очка.',
    rarity: S,
    icon: 'target',
  ...
  badge({
    id: 'beyond',
    title: 'Дальше цели',
    description: 'После вехи пройден ещё один уровень',
    howTo: 'Достигнув вехи, продолжайте развитие и пройдите ещё один уровень.',
    rarity: S,
    icon: 'mountain',
